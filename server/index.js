...
app.post('/api/contact', createRateLimiter(60 * 1000, 5), async (req, res) => {
    try {
...
app.post('/api/lead', createRateLimiter(60 * 1000, 5), async (req, res) => {
    try {
...
app.post('/api/ask-page', askPage_1.askPageHandler);
